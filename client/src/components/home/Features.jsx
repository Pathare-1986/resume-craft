...
const Features = () => {
  return (
    <div
      className="flex flex-col items-center my-10 scroll-mt-12 mt-0 !important"
      id="features"
      style={{marginBottom:"350px"}}
    >
      <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 rounded-full px-6 py-1.5 mb-10">
        <Zap width={14} />
      ...
      <Title
        ...
        description="Our stremlined process helps you create a professional resume in minutes with intelligent AI-Powered tool and features."
      />
